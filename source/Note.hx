...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false)
	{
		...
		else if (mania == 3) frameN = ['purple', 'green', 'red', 'white', 'yellow', 'violet', 'dark'];
		else if (mania == 4) frameN = ['purple', 'blue', 'green', 'red', 'blue', 'red', 'white', 'green', 'purple', 'yellow', 'violet', 'black', 'dark'];
