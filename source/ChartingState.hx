...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var keyAmmo:Array<Int> = [4, 6, 9, 7, 13];
	...
	function addSongUI():Void
	{
		...
		var m_check2 = new FlxUICheckBox(110, 45, null, null, "9", 100);
		...
		m_check2.callback = function()
		{
			...
			var m_check3 = new FlxUICheckBox(60, 45, null, null, "7", 100);
		...
		var m_check4 = new FlxUICheckBox(160, 45, null, null, "13", 100);
	...
	override function update(elapsed:Float)
	{
		curStep = recalculateSteps();
			if (_song.mania == 4 && gridBG.width != S_GRID_SIZE * 26)
		{
			remove(gridBG);
		...
		else if (_song.mania == 3) strumLine.x = 300;
		else if (_song.mania == 4) strumLine.x = 380;
		else strumLine.x = 0;
