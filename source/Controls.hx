...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		inline bindKeys(Control.N4, [C]);
		inline bindKeys(Control.N5, [V]);
		inline bindKeys(Control.N6, [FlxKey.SPACE]);
		inline bindKeys(Control.N7, [B]);
		inline bindKeys(Control.N8, [N]);
		inline bindKeys(Control.N9, [U]);
		inline bindKeys(Control.N10, [I]);
		inline bindKeys(Control.N11, [O]);
		inline bindKeys(Control.N12, [P]);
		...
		switch (scheme)
		{
			...
			case Woops:
				...
				inline bindKeys(Control.N9, [FlxKey.NUMPADFOUR, FlxKey.FOUR]);
				inline bindKeys(Control.N10, [FlxKey.NUMPADFIVE, FlxKey.FIVE]);
				inline bindKeys(Control.N11, [FlxKey.NUMPADSIX, FlxKey.SIX]);
				inline bindKeys(Control.N12, [FlxKey.SHIFT]);
		}
		#else
		...
		bindKeys(Control.N4, [C]);
		bindKeys(Control.N5, [V]);
		bindKeys(Control.N6, [FlxKey.SPACE]);
		bindKeys(Control.N7, [B]);
		bindKeys(Control.N8, [N]);
		bindKeys(Control.N9, [U]);
		bindKeys(Control.N10, [I]);
		bindKeys(Control.N11, [O]);
		bindKeys(Control.N12, [P]);
		switch (scheme)
		{
			case Solo:
