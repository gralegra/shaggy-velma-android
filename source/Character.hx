	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-christmas':
				...
				case 'velmaminus':
				tex = Paths.getSparrowAtlas('velmaminus');
				frames = tex;
				animation.addByPrefix('idle', 'VelmaIdle', 24);
				animation.addByPrefix('singUP', 'VelmaCima', 24);
				animation.addByPrefix('singRIGHT', 'VelmaDireita', 24);
				...
				playAnim('idle');
					...
					case 'velmaminusm':
				tex = Paths.getSparrowAtlas('velmaminusm');
				frames = tex;
				animation.addByPrefix('idle', 'VelmaIdle', 24);
				animation.addByPrefix('singUP', 'VelmaCima', 24);
				animation.addByPrefix('singRIGHT', 'VelmaDireita', 24);
			...
			case 'velma-lost':
				frames = Paths.getSparrowAtlas('velma_lose');
				animation.addByPrefix('idle', "velma lose retry", 24, false);
				animation.addByPrefix('firstDeath', "velma lose start", 30, false);
				animation.addByPrefix('deathLoop', "velma lose loop", 24, true);
				animation.addByPrefix('deathConfirm', "velma lose retry", 24, false);
		...
		if (isPlayer)
		{
			...
			if (!curCharacter.startsWith('bf') && !curCharacter.startsWith('velma-lost'))
			{
				// var animArray
